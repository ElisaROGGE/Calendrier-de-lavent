// let cadeaux = document.querySelectorAll(".box");
// cadeaux.forEach(cadeau => {
//   cadeau.addEventListener('click', event => {
...
jours = document.querySelectorAll('.box');
jours.forEach(element =>{
  element.addEventListener("click", function(){
    let j = element.querySelector(".jour").getAttribute("data-jour");
    if(j > jour){
      // alert("Tricheur !");
